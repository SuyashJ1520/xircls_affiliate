...
const CreateSupport = ({ isQuick = false, setBug, data }) => {
    ...
    const getData = () => {
        getReq('getAllApps', "", affiliateURL)
            .then((res) => {
                console.log(res)
        ...
        getReq('getUserData', "", affiliateURL)
            .then((resp) => {
    ...
    const getIssues = () => {
        ...
        // })
        axios.post(`${affiliateURL}/support-system/product-issues-list/`, form_data)
            .then((resp) => {
                console.log(resp)
    ...
    const createTicket = () => {
        ...
        if (checkForm) {
            ...
            postReq("createSupportTicket", form_data, affiliateURL)
                .then((resp) => {
                    console.log(resp)
