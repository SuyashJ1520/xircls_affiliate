            ...
            <Container className="position-relative h-100">
              <Row className="bg-white h-100">
                ...
                <Col xs={6} className={`xircls-navlinks d-flex px-0`}>
                  ...
                  <Link to='/affiliate/signup/' className="flex-grow-1 px-0 menu-items d-flex bg-white align-items-center font-13px-st letter-spacing-1">Sign-up</Link>
                  <Link to='/affiliate/login/' className="flex-grow-1 px-0 menu-items d-flex bg-white align-items-center font-13px-st letter-spacing-1">Login</Link>
